...
public class Terminal extends javax.swing.JFrame {
    ...
    private void inicializar() {
        ...
        jTextArea2.setText(this.getPrompt());
        jTextArea2.setCaretPosition(this.getPrompt().length());
    ...
    private void initComponents() {
        ...
        javax.swing.tree.DefaultMutableTreeNode treeNode2 = new javax.swing.tree.DefaultMutableTreeNode("etc");
        ...
        jPanel2.add(jScrollPaneArbol, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 330, 140, 150));
        ...
        jlOcultarPista.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        jlMostrarPista.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        jScrollPaneTerminal.setViewportView(jTextArea2);
    ...
    private void jTextArea2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextArea2KeyPressed
        if(evt.getKeyCode() == KeyEvent.VK_ENTER) {
            try {
                ...
                int posCursor = jTextArea2.getCaretPosition();
                int lineaNro = jTextArea2.getLineOfOffset(posCursor);                
                int posInicioLinea = jTextArea2.getLineStartOffset(lineaNro)+longPrompt;
                int posFinalLinea = jTextArea2.getLineEndOffset(lineaNro);
                String lineaTextoIngresada = jTextArea2.getText(posInicioLinea, posFinalLinea-posInicioLinea);
    ...
    private void jSiguienteMisionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jSiguienteMisionActionPerformed
        if (historia.obtenerComandoDeCampania(crSesion.getNroCampania(), crSesion.getProgreso()).equals(t.getEntrada())){//ingresa correctamente el comando
            if (crSesion.jugadorGano())
                ...
                if (crSesion.jugadorAlFinalDeCampania(crSesion.getNroCampania())){//Avanza a la campania siguiente
                    crSesion.setProgreso(0);
                    crSesion.setNroCampania(crSesion.getNroCampania()+1);
                    JOptionPane.showConfirmDialog(null,"Felicitaciones!!!, Avanzaste a la campania "+crSesion.getNroCampania(),
                        "PowerHack",JOptionPane.DEFAULT_OPTION,JOptionPane.INFORMATION_MESSAGE);
                }
                else
                    crSesion.setProgreso(crSesion.getProgreso()+1);
        }
        else{
